...
playTest(`a bot joining a rated lobby unrates it before the game starts`, async ({ sessionManager, session, service, registry }) => {
    /* The ?join= path into the bot's reserved seat in a lobby that asked for a rating. */

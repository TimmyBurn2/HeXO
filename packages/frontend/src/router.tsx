...
function createAppRoutesInternal(trackPageViews: boolean) {
    return createRoutesFromElements(
        <>
            <Route
                element={<AppShell />}
                errorElement={<RouteErrorScreen />}
                middleware={trackPageViews ? [openReplayRouterMiddleware] : undefined}
            >
...
const clientRoutes = createAppRoutesInternal(true);

export function createClientRouter() {
    return createBrowserRouter(clientRoutes);
}

const serverRoutes = createAppRoutesInternal(false);
